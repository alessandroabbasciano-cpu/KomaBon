...
# actually touches, so the existing tree is not reformatted wholesale by this change. 
# Run this script by hand if you want to bring a file (or the whole tree) up to spec.
set -euo pipefail
cd "$(dirname "$0")/.."
