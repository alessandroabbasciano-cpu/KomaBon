...
// Configuration
const DEVICE_WIDTH = 300;  // Portrait orientation
const DEVICE_HEIGHT = 400; // Portrait orientation
...
async function convertBook(epubPath, browser) {
    ...
    try {
        ...
        const chapterResults = new Array(totalChapters);
