// KomaBon — host test for Semantic Versioning comparison used by OTA.
// Build: g++ -std=c++17 -I lib/KomaBon_Core tools/tests/test_semver.cpp
#include <cassert>
#include <cstdio>
#include <string>
#include "SemVer.h"
...
int main() {
    ...
    // The actual jump 1.9.1 -> 1.10.0: a device on the previous version must
    // see this as newer, not the opposite.
